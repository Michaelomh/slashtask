...
export const mockTasks: Task[] = [
  // Overdue
  {
    ...
    description_text: 'Go through the quarterly figures and prepare summary',
    project_id: 'p1',
    priority: 2,
    effort: 3,
    due_date: dateStr(-3),
  ...
  // Today
  {
    id: 't4',
    title: 'Team standup',
    description_text: 'Daily sync with the engineering team',
    project_id: 'p1',
    priority: 2,
    effort: 1,
    due_date: dateStr(0),
  ...
  // Tomorrow
  {
    ...
    description_text: 'Cover the new onboarding flow',
    project_id: 'p1',
    priority: 3,
    effort: 3,
    due_date: dateStr(1),
  ...
  {
    id: 't14',
    title: 'Deep work session: refactor auth module',
    project_id: 'p1',
    priority: 2,
    effort: 4,
    due_date: dateStr(7),
  ...
  {
    id: 't21',
    title: 'Read "Deep Work" chapter 7',
    project_id: 'p4',
    priority: 1,
    effort: 2,
    due_date: dateStr(18),
